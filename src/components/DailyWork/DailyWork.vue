    ...
    <div class="add-area">
      <el-form inline>
        <el-form-item label="添加日程">
          <el-input v-model="name" @keyup.enter.native="handleAddItem" clearable></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <el-col :span="12">
        <el-card class="mg-r-10">
          ...
          <el-table :data="unDoneList" empty-text="任务都已经完成啦">
            ...
            <el-table-column label="日程" prop="name" min-width="150px"></el-table-column>
            <el-table-column label="操作" min-width="150px">
              <template v-slot="{row}">
                <el-button type="primary" size="small" @click="handleDone(row)">已经完成</el-button>
                <el-button type="danger" size="small" @click="handleRemove(row)">删除日程</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-card>
      ...
      <el-col :span="12">
        <el-card class="mg-l-10">
          ...
          <el-table :data="doneList" empty-text="加油把左边的项目都拖到这里">
            ...
            <el-table-column label="操作" min-width="150px">
              <template v-slot="{row}">
                <el-button type="warning" size="small" @click="handleCancelDone(row)">撤销完成</el-button>
                <el-button type="danger" size="small" @click="handleRemove(row)">删除日程</el-button>
              </template>
            </el-table-column>
          </el-table>
